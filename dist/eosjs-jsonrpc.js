...
var JsonRpc = /** @class */ (function () {
     ...
     */
    function JsonRpc(endpoint, WalletCoreApi, args) {
        if (args === void 0) { args = {}; }
    ...
    JsonRpc.prototype.iblFetch = function (functionName, param) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.WalletCoreApi[functionName](param)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data.data];
                    case 2:
                        e_2 = _a.sent();
                        console.log('ttttttt', e_2);
                        throw e_2;
